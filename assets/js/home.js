...
if (isMobile) {
    alert("Error: Este juego no está optimizado para dispositivos móviles. Por favor, usa una computadora.");
    throw new Error("Intento de conexión desde un dispositivo móvil.");
}
